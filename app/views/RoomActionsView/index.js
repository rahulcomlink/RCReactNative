...
class RoomActionsView extends React.Component {
		...
		return (
			<List.Section>
				...
				<List.Item
					title='Video_call'
					onPress={() => 
						{this.sendNotification('Incoming Call', false)
	...
	getInfoOfUser = async(msg, IDUser,onlyAudio) => {
		try {
			...
			if (result.success) {
				...
				this.sendPushNotificationWithCustomPayload(msg,devicetoken,os,onlyAudio)
				}
			}
		}
		catch {
	...
	sendPushNotificationWithCustomPayload = async(msg, devicetoken,os,onlyAudio) => {
