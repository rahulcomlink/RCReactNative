export default {
  ...
  Invisible: "Invisible",
  Invite: "Invite",
  is_a_valid_RocketChat_instance: "is a valid Pigeon instance",
  is_not_a_valid_RocketChat_instance: "is not a valid Pigeon instance",
  is_typing: "is typing",
  ...
  Microphone_Permission_Message:
    "Pigeon needs access to your microphone so you can send audio message.",
  ...
  Not_RC_Server: "This is not a Pigeon server.\n{{contact}}",
  Nothing: "Nothing",
  ...
  Onboarding_title: "Welcome to Pigeon",
  Onboarding_join_open_description:
    "Join our open workspace to chat with the Pigeon team and community.",
  Onboarding_agree_terms: "By continuing, you agree to Pigeon",
  ...
  Read_External_Permission_Message:
    "Pigeon needs to access photos, media, and files on your device",
  ...
  Usually_a_discussion_starts_with_a_question_like_How_do_I_upload_a_picture:
    'Usually, a discussion starts with a question, like "How do I upload a picture?"',
  ...
  You_need_to_access_at_least_one_RocketChat_server_to_share_something:
    "You need to access at least one Pigeon server to share something.",
  ...
  E2E_encryption_reset_description:
    "This option will remove your current E2E key and log you out. \nWhen you login again, Pigeon will generate you a new key and restore your access to any encrypted room that has one or more members online. \nDue to the nature of the E2E encryption, Pigeon will not be able to restore access to any encrypted room that has no member online.",
