export default {
  ...
  "error-avatar-url-handling":
    "خطأ في معالجة الصورة الرمزية ({{url}}) للمستخدم {{username}}",
  "error-cant-invite-for-direct-room":
    "لا يمكن دعوة المستخدم في الغرفة المباشرة",
  ...
  "error-direct-message-file-upload-not-allowed":
    "مشاركة الملفات غير مسموح في الرسالة المباشرة",
  ...
  "error-importer-not-defined":
    "المستورِد معرف بطريقة غير صحيحة، يجب تحديد نوع الإستيراد",
  ...
  "error-invalid-channel-start-with-chars":
    "قناة غير صحيحة. تبدأ القناة بحرف @ أو #",
  "error-invalid-custom-field": "حقل مخصص غير صالح",
  "error-invalid-custom-field-name":
    "اسم الحقل المخصص غير صالح. استخدم الحروف والأرقام والواصلات والشرطات السفلية فقط",
  ...
  "error-invalid-webhook-response":
    "الرد التلقائي من العنوان استجاب برمز مغاير عن 200",
  ...
  "error-message-size-exceeded":
    "حجم الرسالة تجاوز الحد المسموح به (Message_MaxAllowedSize)",
  ...
  "error-remove-last-owner":
    "هذا هو المالك الأخير. يرجى تعيين مالك جديد قبل إزالة هذا المالك",
  ...
  "error-too-many-requests":
    "خطأ، تلقينا الكثير من الطلبات. من فضلك خفف السرعة، يجب الانتظار لمدة {{seconds}} ثانية قبل المحاولة مرة أخرى",
  "error-user-is-not-activated": "المستخدم غير منشط",
  "error-user-has-no-roles": "ليس للمستخدم أدوار",
  "error-user-limit-exceeded":
    "يتجاوز عدد المستخدمين الذين تحاول دعوتهم إلى #channel_name الحد الذي حدده المشرف",
  ...
  "error-user-registration-secret":
    "التسجيل مسموح به عبر عنوان الويب السري فقط",
  "error-you-are-last-owner":
    "أنت المالك الأخير. يرجى تعيين مالك جديد قبل مغادرة الغرفة",
  Actions: "الإجراءات",
  activity: "نشاط",
  Activity: "النشاط",
  ...
  All_users_in_the_channel_can_write_new_messages:
    "يمكن لجميع المستخدمين في القناة كتابة رسائل جديدة",
  ...
  Applying_a_theme_will_change_how_the_app_looks:
    "سيؤدي تطبيق السمة إلى تغيير شكل التطبيق",
  ARCHIVE: "أرشفة",
  archive: "أرشيف",
  are_typing: "يكتب",
  ...
  Broadcast_channel_Description:
    "يمكن فقط للمستخدمين المصرح لهم كتابة رسائل جديدة، ولكن سيتمكن المستخدمون الآخرون من الرد",
  ...
  Clear_cookies_desc:
    "هذا الإجراء سيحذف ملفات تعريف الإرتباط الخاصة بتسجيل الدخول مما يسمح بتسجيل الدخول لحسابات أخرى",
  ...
  Choose_where_you_want_links_be_opened:
    "اختر المكان الذي تريد فتح الروابط فيه",
  Code: "الرمز",
  ...
  Delete_Room_Warning:
    "سيؤدي حذف الغرفة إلى حذف جميع الرسائل المنشورة. لا يمكن التراجع بعد الحذف",
  Department: "القسم",
  delete: "حذف",
  Delete: "حذف",
  DELETE: "حذف",
  ...
  Discussions: "مناقشات",
  Discussion_Desc:
    "ساهم بإعطاء نظرة عامة لما يجري. عند إنشاء مناقشة يتم إنشاء قناة فرعية وربطها بالقناة المحددة",
  ...
  Do_you_really_want_to_key_this_room_question_mark:
    "هل تريد حقاً {{key}} هذه الغرفة؟",
  E2E_How_It_Works_info1:
    "يمكنك الآن إنشاء مجموعات خاصة ورسائل مباشرة مشفرة. بإمكانك أيضاً تشفير المجموعات الخاصة والرسائل المباشرة الموجودة مسبقاً",
  E2E_How_It_Works_info2:
    "التشفير يتم بين الطرفيات بمعنى أن المفتاح سيستخدم لتشفير وفك تشفير رسائلك ولن يتم حفظه في الخادم. لذلك يترتب عليك حفظ كلمة المرور هذه في مكان آمن",
  E2E_How_It_Works_info3: "حين الاستمرار سيتم إنشاء كلمة المرور بين الطرفيات",
  E2E_How_It_Works_info4:
    "بإمكانك أيضاً إنشاء كلمة مرور جديدة لمفتاح التشفير في أي وقت عند دخولك بكلمة المرور الحالية لمفتاح التشفير",
  edit: "تعديل",
  edited: "معدل",
  Edit: "تعديل",
  ...
  Enter_Your_Encryption_Password_desc1:
    "سيمكنك هذا من الوصول لرسائلك المباشرة والمجموعات الخاصة",
  Enter_Your_Encryption_Password_desc2:
    "يجب إدخال كلمة المرور لتشفير وفك تشفير الرسائل المرسلة",
  ...
  For_your_security_you_must_enter_your_current_password_to_continue:
    "من أجل حمايتك، يجب عليك إدخال كلمة المرور الحالية للمتابعة",
  Forgot_password_If_this_email_is_registered:
    "إن كان البريد الإلكتروني مسجلاً، فسنرسل تعليمات إعادة تعيين كلمة المرور الخاصة بك. إذا لم تتلق بريداً إلكترونياً قريباً، فيرجى العودة والمحاولة مرة أخرى",
  ...
  In_App_and_Desktop_Alert_info:
    "يعرض شعاراً أعلى الشاشة عندما يكون التطبيق مفتوحًا، ويعرض إشعاراً على سطح المكتب",
  Invisible: "غير مرئي",
  Invite: "دعوة",
  is_a_valid_RocketChat_instance: "خادم Pigeon صالح",
  is_not_a_valid_RocketChat_instance: "خادم Pigeon غير صالح",
  is_typing: "يكتب",
  Invalid_or_expired_invite_token: "رمز الدعوة غير صالح أو منتهي الصلاحية",
  Invalid_server_version:
    "الخادم الذي تحاول الاتصال به يستخدم إصدارا لم يعد مدعوماً: {{currentVersion}}.\n\n النسخ المدعومة تبدأ من {{minVersion}}",
  ...
  Just_invited_people_can_access_this_channel:
    "يمكن للأشخاص المدعوين فقط الوصول إلى هذه القناة",
  Language: "اللغة",
  ...
  Microphone_Permission_Message:
    "يحتاج Pigeon للوصول إلى الميكروفون الخاص بك حتى تتمكن من إرسال رسالة صوتية",
  ...
  Not_RC_Server: "هذا ليس بخادم Pigeon.\n{{contact}}",
  Nothing: "لا شيء",
  ...
  Onboarding_description:
    "مساحة عمل هي مساحة لفريقك ومنظمتك للتعاون. اطلب من المشرف العنوان للانضمام أو أنشئ لفريقك",
  Onboarding_join_workspace: "انضم لمساحة عمل",
  Onboarding_subtitle: "ما بعد بيئة فريق تعاونية",
  Onboarding_title: "مرحبا بك في Pigeon",
  Onboarding_join_open_description:
    "انضم لمساحة عملنا للتواصل مع فريق Pigeon ومع المجتمع",
  Onboarding_agree_terms: "بالمواصلة أنت توافق على Pigeon",
  Onboarding_less_options: "خيارات أقل",
  Onboarding_more_options: "خيارات أكثر",
  Online: "متصل",
  Only_authorized_users_can_write_new_messages:
    "يمكن للمستخدمين المصرح لهم فقط كتابة رسائل جديدة",
  ...
  Open_your_authentication_app_and_enter_the_code:
    "افتح تطبيق المصادقة الخاص بك وأدخل الرمز",
  OR: "أو",
  OS: "نظام التشغيل",
  ...
  Push_Notifications_Alert_Info:
    "يتم إرسال هذه الإشعارات إليك عندما لا يكون التطبيق مفتوحاً",
  Quote: "اقتباس",
  ...
  Read_External_Permission_Message:
    "يحتاج Pigeon للوصول إلى الصور والملفات الموجودة على الجهاز",
  ...
  Room_changed_announcement:
    "تم تغيير إعلان الغرفة إلى: {{announcement}} من قبل {{userBy}}",
  Room_changed_description:
    "تم تغيير وصف الغرفة إلى: {{description}} من قبل {{userBy}}",
  ...
  Save_Your_Encryption_Password_warning:
    "لا نقوم بتخزين كلمة المرور، الرجاء حفظها لديك في مكان آخر",
  Save_Your_Encryption_Password_info:
    "لا يمكن إستعادة كلمة المرور في حال فقدانها ولن تستطيع الوصول لرسائلك",
  Search_Messages: "بحث الرسائل",
  Search: "بحث",
  Search_by: "بحث حسب",
  Search_global_users: "بحث عام عن المستخدمين",
  Search_global_users_description:
    "إذا قمت بالتفعيل، فسيمكنك البحث عن أي مستخدم في شركات أو خوادم أخرى",
  ...
  Set_username_subtitle:
    "يتم استخدام اسم المستخدم للسماح للآخرين بذكرك في الرسائل",
  ...
  Show_Unread_Counter_Info:
    "يتم عرض العدد غير المقروء كشارة على يمين القناة في القائمة",
  ...
  The_user_wont_be_able_to_type_in_roomName:
    "المستخدم لن يتمكن من الكتابة في {{roomName}}",
  The_user_will_be_able_to_type_in_roomName:
    "المستخدم سيتمكن من الكتابة في {{roomName}}",
  ...
  User_is_no_longer_role_by_:
    "تم إزالة الدور {{role}} عن المستخدم {{user}} من قبل {{userBy}}",
  ...
  User_was_set_role_by_:
    "أضيف دور {{role}} للمستخدم {{user}} من قبل {{userBy}}",
  ...
  Usually_a_discussion_starts_with_a_question_like_How_do_I_upload_a_picture:
    "عادةً، النقاش يبدأ بسؤال، على سبيل المثال: كيف أرفع صورة؟",
  Validating: "يتم التحقق",
  Registration_Succeeded: "تم التسجيل بنجاح",
  Verify: "تحقق",
  Verify_email_title: "تم التسجيل!",
  Verify_email_desc:
    "لقد أرسلنا إليك بريداً إلكترونياً لتأكيد تسجيلك. إذا لم تتلق البريد الإلكتروني قريباً، فيرجى العودة والمحاولة مرة أخرى",
  Verify_your_email_for_the_code_we_sent:
    "يرجى تأكيد البريد الإلكتروني عبر الرمز المرسل",
  ...
  Write_External_Permission_Message:
    "يحتاج Pigeon للوصول إلى معرض الصور الخاص بك حتى تتمكن من حفظ الصور",
  ...
  Logged_out_by_server:
    "لقد تم تسجيل خروجك من قبل الخادم. الرجاد الدخول من جديد",
  You_need_to_access_at_least_one_RocketChat_server_to_share_something:
    "تحتاج إلى الوصول إلى خادم Pigeon واحد على الأقل لمشاركة شيء ما",
  You_need_to_verifiy_your_email_address_to_get_notications:
    "يجب تأكيد البريد الإلكتروني حتى تصلك الإشعارات",
  Your_certificate: "شهادتك",
  Your_message: "رسالتك",
  Your_invite_link_will_expire_after__usesLeft__uses:
    "سوف تنتهي صلاحية رابط الدعوة الخاص بك بعد {{usesLeft}} استخدامات",
  Your_invite_link_will_expire_on__date__or_after__usesLeft__uses:
    "ستنتهي صلاحية رابط الدعوة الخاص بك في {{date}} أو بعد {{usesLeft}} استخدامات",
  Your_invite_link_will_expire_on__date__:
    "ستنتهي صلاحية رابط الدعوة الخاص بك في {{date}}",
  ...
  You_will_not_be_able_to_recover_this_message:
    "لن تتمكن من استعادة هذه الرسالة!",
  You_will_unset_a_certificate_for_this_server: "ستلغي شهادة هذا الخادم",
  Change_Language: "تغيير اللغة",
  Crash_report_disclaimer:
    "نحن لا نتتبع محتوى محادثاتك أبداً. يحتوي تقرير الأعطال فقط على المعلومات ذات الصلة لنا من أجل تحديد المشاكل وإصلاحها",
  ...
  You_will_be_logged_out_of_this_application:
    "سيتم تسجيل خروجك من هذا التطبيق.",
  Clear: "مسح",
  This_will_clear_all_your_offline_data:
    "سيؤدي هذا إلى محو جميع بياناتك في وضع عدم الاتصال.",
  This_will_remove_all_data_from_this_server:
    "هذا الإجراء يحذف جميع البيانات من هذا السيرفر",
  ...
  You_will_be_logged_out_from_other_locations:
    "سيتم تسجيل خروج من الأماكن الأخرى",
  Logged_out_of_other_clients_successfully:
    "تم تسجيل الخروج من الأماكن الأخرى بنجاح",
