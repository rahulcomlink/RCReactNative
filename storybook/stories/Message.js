...
export default ({ theme }) => {
    ...
    <ScrollView style={{ backgroundColor: themes[theme].backgroundColor }}>
      ...
      <Message msg="How are you?" tcount={9999} tlm={date} />
      ...
      <Separator
        title="Sequential thread messages following thread button"
        theme={theme}
      />
      <Message msg="How are you?" tcount={1} tlm={date} />
      ...
      <Separator
        title="Sequential thread messages following thread reply"
        theme={theme}
      />
      <Message msg="I'm fine!" tmid="1" tmsg="How are you?" isThreadReply />
      ...
      <Message
        ...
        broadcast
        replyBroadcast={() => alert("broadcast!")}
      />
      ...
      <Message
        msg="Message"
        style={[styles.normalize, { backgroundColor: "#ddd" }]}
      />
